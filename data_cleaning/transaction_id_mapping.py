...
DEFAULT_TRANSACTION_OUTPUT_DIR = os.path.join(PROJECT_ROOT, "data", "transaction_cleaned")
...
def run(prime_cleaned_dir=None, transaction_input_dir=None, transaction_output_dir=None):
    """
    ...
    if not active_files:
        print(f"ERROR: No active files found in '{prime_cleaned_dir}/'. Run prime_id_creation.run() first.")
        return
